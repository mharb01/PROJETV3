 ...
 * @author HP
 */
public class CandidatureEtGrid extends Grid <Candidature> {
    
    public CandidatureEtGrid (List<Candidature> candidatures) {
            ...
            suppButton.addClickListener(event -> {
                ...
                Button confirmButton = new Button("Oui", e -> {
                    ...
                    CandidatureEtGrid.supprimer(con, candidature);
