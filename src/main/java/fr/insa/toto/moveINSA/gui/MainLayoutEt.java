...
import fr.insa.toto.moveINSA.gui.vueetudiant.MenuGaucheEt;

/**
 *
 * @author HP
 */
public class MainLayoutEt extends AppLayout implements BeforeEnterObserver {

    private MenuGaucheEt menuGaucheEt;

    public MainLayoutEt () {
//        System.out.println("MainLayout constructeur "+this);
        this.menuGaucheEt = new MenuGaucheEt();
        this.menuGaucheEt.setHeightFull();
...
//        scroller.setScrollDirection(Scroller.ScrollDirection.VERTICAL);
//        scroller.setHeightFull();
        this.addToDrawer(this.menuGaucheEt);
