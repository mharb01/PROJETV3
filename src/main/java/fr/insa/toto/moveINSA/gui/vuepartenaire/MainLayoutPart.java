 ...
 * @author HP
 */
public class MainLayoutPart extends AppLayout implements BeforeEnterObserver{
    private MenuGauchePart menuGauchePart;

    public MainLayoutPart () {
//        System.out.println("MainLayout constructeur "+this);
        this.menuGauchePart = new MenuGauchePart();
        this.menuGauchePart.setHeightFull();
...
//        scroller.setScrollDirection(Scroller.ScrollDirection.VERTICAL);
//        scroller.setHeightFull();
        this.addToDrawer(this.menuGauchePart);
