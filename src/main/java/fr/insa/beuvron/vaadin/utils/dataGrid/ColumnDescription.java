 ...
 *     <ul>
 *       <li> colData affiche la donnée </li>
 *     </ul>
 *     </li>
 ...
 * </p>
 * <p> défini aussi quelques options les plus souvent utilisées : 
 * <ul>
 *   <li> visible : vrai par défaut, si faux, la colonne existe dans la grid, mais n'est pas affichée 
 *        pratique par exemple pour conserver les identificateur sans les afficher
 *   </li>
 *   <li> autoWidth : vrai par défaut : adapte la largeur de la colonne à la taille des données contenues </li>
 *   <li> sortable : faux par défaut : si vrai permet à l'utilisateur de trier sur la colonne </li>
 * </ul>
 * </p>
 * </pre>
 *
...
public class ColumnDescription {
    ...
    /**
     * indique si la taille de la colonne est automatiquement redimensionnée
     */
    private boolean autoWidth;

    /**
     * indique si colonne peut être triée
     */
    ...
    /**
     * défini si la colonne peut être triée (par défaut non).
     * @param auto
     * @return 
     */
    public ColumnDescription sortable(boolean auto) {
        this.sortable = auto;
        return this;
    }
